...
void Display::drawPixelArray(const uint8_t *pixels, const uint8_t palette[][3], uint8_t backgroundPixelSize, int xStart, int yStart, int xSize, int ySize) {
...
void Display::drawGame(Difficulty selectedDifficulty){
    ...
    for(uint8_t i = 0; i < (level.gridSize * level.gridSize); i++){

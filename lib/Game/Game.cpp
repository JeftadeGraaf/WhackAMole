...
// Constructor
Game::Game(IRComm &ir, Display &display, Timer1Overflow &timer1) : ir(ir),
                                                                   display(display),
                                                                   timer1(timer1)
{
}
...
void Game::updateGame(bool ZPressed)
{
    ...
    if (display.characterMole)
    {
        ...
        { // Check if mole has been placed for 2 seconds
